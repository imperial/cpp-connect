 ...
 * 1. The default `onSuccess` handler will call the `close` prop when the form is successfully submitted, however it can be overridden completely by passing a new `onSuccess` prop.
